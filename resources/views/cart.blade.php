    ...
    <div class="row" style="background-color:#111111">
        <div class="col">
            <nav class="navbar navbar-expand-lg navbar-dark p-0 py-2" style="background-color:#111111">
                <p class="text-white my-auto">OUR COSTUMER CARE : +62 81 29 777 29 46</p>
...
<div class="container mt-3">
    ...
    <div class="row mt-3 text-white">
        <div class="col">
            <br><span><a class="text-white" href="{{ url('/') }}">Beranda</a> &nbsp;/&nbsp; Keranjang</span>
        </div>
    </div>
        ...
        <div class="col">
            <table class="table table-dark table-hover">
                ...
                <tbody>
                    @for($i=0;$i<3;$i++)
                    <tr>
                    <th class="align-middle" scope="row"><a href="#">X</a></th>
                    <td class="align-middle"><img src="https://place-hold.it/100x100" alt=""></td>
                    <td class="align-middle">Baju</td>
                    <td class="align-middle">100.000</td>
                    <td class="align-middle" width="200"><input type="text" class="col-sm-4 p-0 bg-dark text-center text-white mx-auto" value="2"></td>
                    <td class="align-middle">100.000</td>
                    </tr>
                    @endfor
                </tbody>
    ...
    <hr class="divider" style="background-color:#111111">
        <div class="d-flex flex-row py-2">
            <div class="input-group mb-3 my-auto col-md-4 m-0 p-0" width="150">
            ...
            <a class="col-md-2 ml-auto btn btn-dark text-white-50 border border-info" id="basic-addon2">Perbaharui Keranjang</a>
        </div>
    <hr class="divider" style="background-color:#111111">

    <div class="d-flex flex-row my-4">
        <h3 class="text-white ml-auto col-md-5">Total Keranjang Belanja</h3>
    </div>
    ...
    <div class="d-flex flex-row justify-content-end m-0 p-0">
        <p class="p-2 pl-3 text-white col-md-3" style="background-color:rgb(26,26,26);">Pengiriman</p>
        <p class="p-2 pl-3 text-white col-md-3" style="background-color:rgb(26,26,26);">POS - Paket Kilat Khusus (8 Days): Rp72.000 Dikirim Ke Jl.Inpres No.51, Balikpapan Utara, Muara Rapak, Kalimantan Timur 76128</p>
    </div>
    <div class="d-flex flex-row justify-content-end m-0 p-0">
